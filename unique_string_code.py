...
import numpy as np
import nltk
# nltk.download("punkt") and nltk.download('stopwor)
...
curr_file = open('phase3_start_abstract_bib.csv', encoding="utf8", errors='ignore')
...
stopwords.extend(('also', 'using'))
running_list_no_sw = [item for item in running_list if item.lower() not in
                      stopwords]
